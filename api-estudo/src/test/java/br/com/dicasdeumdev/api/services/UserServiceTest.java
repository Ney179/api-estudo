...
class UserServiceTest {
	...
	private static final String EMAIL    = "mirian@gmail.com";
	private static final String NAME     = "Mirian";
	...
	void whenFindByIdThenReturnAnUserInstance() {
		when(respository.findById(anyInt())).thenReturn(optionalUser);
    ...
    void whenFindByIdThenReturnAnObjectNotFoundException() {
		when(respository.findById(anyInt()))
	...
	void whenFindAllThenReturnAnListOfUsers() {
		when(respository.findAll()).thenReturn(List.of(user));
    ...
    void whenCreateThenReturnAnDataIntegrityViolationException() {
		when(respository.findByEmail(anyString())).thenReturn(optionalUser);
	...
	void whenDeleteWithSuccess() {
		when(respository.findById(anyInt())).thenReturn(optionalUser);
		doNothing().when(respository).deleteById(anyInt());
		service.delete(ID);
		verify(respository, times(1)).deleteById(anyInt());
	}
